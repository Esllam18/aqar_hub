...
const EgyptLocationNode northSinaiGovernorate = EgyptLocationNode(
  ...
  children: [
    ...
    EgyptLocationNode(slug: 'sheikh_zuweid', enName: 'Sheikh Zuweid', arName: 'الشيخ زويد', aliases: ['sheikh zuweid', 'الشيخ زويد', 'sheikh-zuweid']),
    EgyptLocationNode(slug: 'bir_el_abed', enName: 'Bir El Abed', arName: 'بئر العبد', aliases: ['bir el abed', 'بئر العبد', 'bir-el-abed']),
