...
import 'package:aqar_hub/features/owner/home/presentation/views/owner_sale/sale_property_card.dart';
    ...
    return BlocProvider(
      create: (_) =>
          HomeCubit(PropertyRepositoryImpl(PropertyDatasourceImpl()))
            ..loadProperties(
              filter: const PropertyFilterModel.empty()
                  .copyWith(listingType: 'sale'),
            ),
    ...
    return RefreshIndicator(
      ...
      child: CustomScrollView(
        ...
        slivers: [
          ...
          SliverPadding(
            padding:
                context.rOnly(left: 16, right: 16, top: 8, bottom: 40),
            sliver: SliverList(
      ...
      child: SafeArea(
        ...
        child: Stack(children: [
          Positioned(
            top: -20, right: -20,
            child: Container(
              width: context.r(160), height: context.r(160),
          ...
          Padding(
            padding:
                context.rOnly(left: 20, right: 20, top: 16, bottom: 28),
            child: Column(
    ...
    return Center(
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Icon(Icons.error_outline_rounded,
            size: context.r(52), color: Colors.grey.shade300),
        SizedBox(height: context.r(16)),
        Text(messageKey.tr(context),
            style: GoogleFonts.tajawal(
        ...
        ElevatedButton.icon(
          ...
          label: Text('btn_retry'.tr(context),
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Container(
          ...
          child: Icon(Icons.sell_outlined,
              size: context.r(38), color: const Color(0xFF7C3AED)),
        ),
        SizedBox(height: context.r(20)),
        Text('sale_empty_title'.tr(context),
            style: GoogleFonts.cairo(
                fontSize: context.sp(17),
                fontWeight: FontWeight.w800,
                color: const Color(0xFF1B2D5E))),
        SizedBox(height: context.r(8)),
        Text('sale_empty_subtitle'.tr(context),
            textAlign: TextAlign.center,
            style: GoogleFonts.tajawal(
